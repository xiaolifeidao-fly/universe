  ...
  return (
    <main className="screen business-home">
      <header className="business-home__hero">
        <div className="business-home__mark"><BriefcaseBusiness size={24} aria-hidden="true" /></div>
        <p className="eyebrow">业务</p>
        <h1>业务诉求</h1>
        <p>提出一线业务想法，或查看当前空间已经收集的诉求。</p>
        <div className="business-personas" aria-label="当前工作身份">
          {business ? <span><MessageSquareText size={16} />业务方</span> : null}
          {productResearch ? <span><ShieldCheck size={16} />产品产研</span> : null}
        </div>
      </header>
      ...
      <section className="business-entry-list" aria-label="业务栏目入口">
        {business ? (
          <Link className="business-entry" href="/business/workbench">
            <span className="business-entry__icon is-green"><MessageSquareText size={23} /></span>
        ...
        {productResearch ? (
          <Link className="business-entry" href="/business/intake">
            <span className="business-entry__icon"><ClipboardList size={23} /></span>
