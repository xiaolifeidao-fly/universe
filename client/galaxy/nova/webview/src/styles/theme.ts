 ...
 * antd 主题。
 *
 * antd 在 Nova 里只负责浮层（Modal / Select / Popconfirm / message / Spin）——
...
const ACCENT = "#b4531f";
const ACCENT_HOVER = "#8f3f14";
const INK = "#1c1917";
const SURFACE = "#fffdfa";
const APP = "#f6f3ee";
const LINE = "rgba(28, 25, 23, 0.09)";
const BORDER = "rgba(28, 25, 23, 0.16)";
const SOFT = "#57534e";
const FAINT = "#8a847c";
...
export const galaxyTheme: ThemeConfig = {
  ...
  components: {
    ...
    Select: { controlHeight: 38, borderRadius: 10, optionSelectedBg: "rgba(180, 83, 31, 0.10)" },
    Modal: { borderRadiusLG: 16, titleFontSize: 16 },
    Message: { contentBg: SURFACE },
    Tooltip: { borderRadius: 8 },
    Segmented: { itemSelectedBg: SURFACE, trackBg: "rgba(28, 25, 23, 0.05)" },
  },
};
