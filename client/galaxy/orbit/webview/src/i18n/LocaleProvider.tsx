...
const messages = {
  "zh-CN": {
    ...
    "keys.notRevealable": "这把密钥签发时平台还不保存明文，取不回来。换发一次，新密钥就能复制和一键使用。",
    "keys.use.button": "使用",
    ...
    "issued.body": "密钥明文由平台加密保存着，之后随时能在密钥页复制；在 Orbit 桌面端还能一键接到 Claude Code / Codex。",
    "issued.goKeys": "去密钥页",
    "issued.done": "知道了",
  ...
  "en-US": {
    ...
    "keys.notRevealable": "This key was issued before the platform stored plaintext, so it can't be retrieved. Reissue it and the new key can be copied and connected in one click.",
    "keys.use.button": "Use",
    ...
    "issued.body": "The platform keeps the key encrypted — copy it from the Keys page any time, or connect it to Claude Code / Codex in one click in the Orbit desktop app.",
