...
const messages = {
  "zh-CN": {
    ...
    "home.steps.1.title": "注册就有一把密钥",
    "home.steps.1.body": "注册完自动给你一把，之后在控制台还能再建，最多 5 把。",
  ...
  "en-US": {
    ...
    "home.steps.1.title": "A key comes with your account",
    "home.steps.1.body": "One is created for you at sign-up; add more in the console, up to five.",
