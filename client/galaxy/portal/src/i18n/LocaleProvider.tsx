...
const messages = {
  "zh-CN": {
    ...
    "unit.llm.input_tokens": "新增输入 token",
    ...
    "home.steps.1.title": "在控制台生成一把密钥",
    "home.steps.1.body": "注册就能建，最多 5 把。明文只显示这一次，记得先存下来。",
    ...
    "home.cta.title": "先充一点试试",
    "home.cta.body": "余额不清零，跑一天不合适就停下来，剩下的还在账户里。",
  ...
  "en-US": {
    ...
    "unit.llm.input_tokens": "New input tokens",
    ...
    "home.steps.1.title": "Create a key in the console",
    "home.steps.1.body": "Sign up and create one, up to five. The secret is shown once — save it then.",
    ...
    "home.cta.title": "Start with a small top-up",
    "home.cta.body": "Balance does not expire into thin air. Try it for a day; whatever is left stays on the account.",
