...
func Run() {
	...
	log.Printf("galaxy-hub-api listening on %s", bootstrap.ListenAddress("GALAXY_HUB_API_ADDR", ":10006"))
	if err := engine.Run(bootstrap.ListenAddress("GALAXY_HUB_API_ADDR", ":10006")); err != nil {
		log.Fatal(err)
	}
}
